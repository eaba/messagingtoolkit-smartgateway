...
namespace MessagingToolkit.SmartGateway.Core
{
    public partial class frmTestForm : Form
    {
        ...
        {
            //logMonitor1.FileName = @"C:\MySpace\2009\MessagingToolkit\MessagingToolkit.SmartGateway.ManagementConsole\bin\Debug\service.log";
        ...
        {
            MessageBox.Show(parameters[0].ToString());
        }

        private void configurationViewPanel1_Load(object sender, EventArgs e)
        {
